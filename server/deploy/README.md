...
7. Install Nginx and use `nginx.conf.example` with the real API domain. The exact `/api/agent/register` route is sent to the Python service on port 8788; other routes remain on the Node service on port 8787.
