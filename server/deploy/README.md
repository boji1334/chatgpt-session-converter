...
6. Issue a TLS certificate with Certbot, then set the frontend `quota-api-url` to `https://api.example.com/api/quota/check` and `agent-api-url` to `https://api.example.com/api/agent/register`.
